...
export default function Home() {
    ...
    '@graph': [
      {
        ...
        alternateName: 'MyDigital Crown - Digital Marketing Company Chandigarh',
        ...
        description: 'Leading Digital Marketing Company in Chandigarh offering comprehensive digital marketing services including SEO, Google Ads, Social Media Marketing, and Web Development.',
        founder: {
          '@type': 'Person',
          name: 'Aditya',
      ...
      },
      {
        ...
        name: 'MyDigital Crown - Digital Marketing Company Chandigarh',
        ...
        hasOfferCatalog: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Social Media Marketing Chandigarh',
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Google Ads Management Chandigarh',
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Web Development Chandigarh',
      ...
      },
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'What is the best digital marketing company in Chandigarh?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'MyDigital Crown is one of the leading digital marketing companies in Chandigarh, offering 50+ services including SEO, Google Ads, Social Media Marketing, and Web Development with 8+ years of experience and 150+ satisfied clients.'
            }
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Digital marketing costs in Chandigarh vary based on services. At MyDigital Crown, we offer customized packages starting from ₹15,000/month for SEO to ₹50,000/month for comprehensive digital marketing solutions.'
            }
          },
          {
            '@type': 'Question',
            name: 'Which digital marketing agency is best in Chandigarh?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'MyDigital Crown is recognized as one of the best digital marketing agencies in Chandigarh, providing result-driven strategies with a proven track record of 300% average ROI for clients.'
            }
          }
        ]
      },
      ...
      },
      {
        ...
        url: 'https://mydigitalcrown.in',
        name: 'MyDigital Crown - Digital Marketing Company Chandigarh',
        description: 'Leading Digital Marketing Company in Chandigarh offering SEO, Social Media Marketing, Google Ads, Web Development & 50+ Digital Marketing Services',
        publisher: {
          '@id': 'https://mydigitalcrown.in/#organization'
        },
        potentialAction: [
  ...
  return (
    <>
      ...
      {/* Hero Section - Main Content for Digital Marketing Company in Chandigarh */}
      <section 
        className="pt-16 py-16 bg-gradient-to-br from-blue-800 to-blue-600 relative overflow-hidden"
        itemScope 
        itemType="https://schema.org/Organization"
        aria-label="Digital Marketing Company Chandigarh Hero Section"
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-3 mb-6 shadow-xl">
                ...
                <span className="text-white font-semibold" itemProp="slogan">Chandigarh&apos;s Leading Digital Marketing Company</span>
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              </div>
              ...
              <h1 
                ...
                itemProp="name"
              >
                #1 Digital Marketing Company In Chandigarh - MyDigital Crown
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                <Link 
                  ...
                  title="Get Free Digital Marketing Consultation Chandigarh"
                  aria-label="Contact best digital marketing company in Chandigarh for free audit"
                >
                ...
                <a 
                  ...
                  title="Call Best Digital Marketing Agency Chandigarh"
                  aria-label="Call MyDigital Crown - Top Digital Marketing Company Chandigarh"
                >
                  <span className="relative z-10 flex items-center gap-3">
      ...
      {/* About Us Section - Digital Marketing Consultants Chandigarh */}
      <section 
        className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden"
        aria-label="About MyDigital Crown - Digital Marketing Agency Chandigarh"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <header className="text-center mb-16">
            <div className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg">
              ...
              About MyDigital Crown - Digital Marketing Consultants in Chandigarh
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Choose MyDigital Crown as Your <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Digital Marketing Partner</span> in Chandigarh?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              <strong>Looking for experienced digital marketing consultants in Chandigarh?</strong> We are a trusted digital marketing agency in Chandigarh transforming businesses through innovative digital marketing strategies since 2017
            </p>
          </header>
              ...
              <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-2 shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                <div className="relative rounded-2xl overflow-hidden bg-white">
                  <Image 
                    ...
                    alt="Aditya Pandey - Founder & Digital Marketing Consultant Chandigarh | Best Digital Marketing Company"
                    width={600}
                    height={700}
                    className="w-full h-auto object-cover"
                    priority
                    title="Aditya Pandey - Digital Marketing Expert Chandigarh"
                  />
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Welcome to <span className="font-bold text-blue-600">MyDigital Crown</span> - Chandigarh&apos;s premier digital marketing agency founded by <span className="font-bold">Aditya Pandey</span>. With over 8 years of industry experience, we&apos;ve helped 50+ businesses achieve remarkable growth through innovative digital marketing strategies.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  ...
                  title="Learn About Chandigarh&apos;s Best Digital Marketing Company"
                  aria-label="Learn more about MyDigital Crown - Top Digital Marketing Agency Chandigarh"
                >
                  <span className="relative flex items-center">
                    <span className="mr-2">📖</span>
                    Learn About Best Digital Marketing Company Chandigarh
                  </span>
                </Link>
                <Link 
                  href="/contact" 
                  ...
                  title="Contact Digital Marketing Agency Chandigarh - Free Consultation"
                  aria-label="Contact MyDigital Crown for Digital Marketing Services Chandigarh"
                >
      ...
      {/* Services Section - Digital Marketing Services Chandigarh */}
      <section 
        className="py-20 bg-white relative overflow-hidden"
        aria-label="Digital Marketing Services in Chandigarh"
        itemScope 
            ...
            <Link href="/services/search-engine-optimisation" className="group relative rounded-3xl overflow-hidden border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="SEO Services Chandigarh - Digital Marketing Company | Search Engine Optimization Agency"
                  fill
            ...
            <Link href="/services/social-media-marketing" className="group relative rounded-3xl overflow-hidden border-2 border-pink-200 hover:border-pink-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="Social Media Marketing Chandigarh - Best Digital Marketing Agency | Instagram Facebook LinkedIn Marketing"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/services/google-ads" className="group relative rounded-3xl overflow-hidden border-2 border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="Google Ads PPC Chandigarh - Digital Marketing Company | Pay Per Click Advertising Agency"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/services/web-development" className="group relative rounded-3xl overflow-hidden border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="Web Development Chandigarh - Digital Marketing Company | Custom Website Development Agency"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              What Chandigarh <span className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent">Businesses</span><br />
              Say About Us
            </h2>
            
            <p className="text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed">
              Real results, real clients, real growth stories from Chandigarh&apos;s most successful businesses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl">
              ...
              <div className="mb-6">
                ...
                <blockquote className="text-lg text-white/90 leading-relaxed italic">
                  &quot;Our cleaning service flourished after partnering with MyDigital Crown. Their local SEO strategies helped us dominate Chandigarh&apos;s market. We now get <span className="text-cyan-400 font-bold">50+ inquiries weekly</span>. Outstanding team!&quot;
                </blockquote>
              </div>
              <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              MyDigital Crown serves clients across India with our main offices strategically located in Chandigarh, Varanasi, and Bangalore. Visit us for personalized digital marketing consultations and discover why we&apos;re recognized as a top digital marketing company.
            </p>
            ...
            <div className="group">
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Chandigarh Service Area</h3>
                  ...
                  <div className="flex flex-col space-y-2 text-gray-700">
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <span className="text-sm">Chandigarh (Union Territory)</span>
                    </div>
                    <div className="flex items-center justify-center space-x-2">
                      <svg className="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
          ...
          <div className="text-center mt-16">
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-12 shadow-2xl border border-white/50 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Schedule a free consultation with our digital marketing experts at any of our three locations - Chandigarh, Varanasi, or Bangalore. We&apos;re here to help transform your business with data-driven strategies.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-blue-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Everything you need to know about digital marketing services in Chandigarh ✨
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-orange-500/20 hover:border-orange-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-orange-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>What makes MyDigital Crown the best digital marketing company in Chandigarh?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p>MyDigital Crown stands out as Chandigarh&apos;s premier digital marketing agency with 8+ years of experience, 150+ happy clients, and a proven track record of delivering 300% average growth. We offer 50+ specialized services including SEO, Google Ads, social media marketing, web development, and more. Our data-driven strategies, 24/7 support, and commitment to measurable results make us the preferred choice for businesses in Chandigarh looking to dominate their digital landscape.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-blue-500/20 hover:border-blue-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-blue-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>What digital marketing services do you offer in Chandigarh?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-green-500/20 hover:border-green-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-green-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>How much does digital marketing cost in Chandigarh?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-yellow-500/20 hover:border-yellow-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-yellow-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-bounce">📍</span>
                  <span>Do you provide local SEO services for Chandigarh-based businesses?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p className="mb-4">Yes! We specialize in local SEO for Chandigarh businesses. Our local SEO services include:</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">✅ Google Business Profile optimization and management</li>
                  <li className="flex items-start gap-2">✅ Local keyword research and targeting (Chandigarh-specific)</li>
                  ...
                  <li className="flex items-start gap-2">✅ Map pack optimization for Chandigarh searches</li>
                </ul>
                <p className="mt-4">We help your business dominate local search results when potential customers in Chandigarh search for your services.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-pink-500/20 hover:border-pink-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-pink-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-pulse">🚀</span>
                  <span>Can you help my small business compete with larger companies in Chandigarh?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">📍 Local SEO to dominate specific Chandigarh neighborhoods</li>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-cyan-500/20 hover:border-cyan-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-cyan-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-spin">🏢</span>
                  <span>What industries do you serve in Chandigarh?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p className="mb-4">We serve businesses across all major industries in Chandigarh including:</p>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-red-500/20 hover:border-red-300/50 hover:scale-105">
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <p className="mt-4">Our social media experts create engaging content, manage communities, run targeted ad campaigns, and provide detailed analytics to grow your brand presence in Chandigarh and beyond.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-teal-500/20 hover:border-teal-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-teal-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-bounce">🌐</span>
                  <span>Can you help with website design and development in Chandigarh?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-rose-500/20 hover:border-rose-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-rose-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-pulse">⭐</span>
                  <span>What sets your digital marketing agency apart from others in Chandigarh?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">📍 <strong>Local Chandigarh Expertise:</strong> Deep understanding of Chandigarh&apos;s market dynamics</li>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore exciting career opportunities and grow with Chandigarh&apos;s leading digital marketing agency
            </p>
          </div>
