...
export const metadata: Metadata = {
  title: 'SEO Company Kolkata | 400+ Clients Ranked #1 | MyDigital',
  description: 'SEO Company Kolkata. 400+ Clients Ranked #1 | 500% Traffic Growth | Local & National SEO | Google Certified Experts. Call +91-83695-11877',
  keywords: [
    ...
    'professional seo services kolkata',
    ...
    'seo optimization kolkata',
    'affordable seo kolkata',
    'seo firm kolkata',
    'organic seo kolkata',
    'seo marketing kolkata',
    'google seo kolkata',
    'kolkata seo expert',
    'seo packages kolkata',
    'seo solutions kolkata',
    'enterprise seo kolkata',
    'seo consultant in kolkata',
    'white hat seo kolkata',
    'kolkata seo agency',
    'best seo services kolkata',
    'seo company for small business kolkata',
    'ecommerce seo kolkata',
    'technical seo kolkata',
    'kolkata seo optimization',
    'seo and digital marketing kolkata'
  ],
  ...
  openGraph: {
    title: 'SEO Company In Kolkata | #1 SEO Services Agency',
    description: 'Top SEO Company In Kolkata. 400+ Clients Ranked #1. 500% Traffic Growth. Expert SEO Services.',
    url: 'https://mydigitalcrown.in/kolkata/search-engine-optimisation',
    siteName: 'MyDigital Crown',
    locale: 'en_IN',
    type: 'website',
    images: [
      {
        url: 'https://mydigitalcrown.in/images/seo-company-kolkata.jpg',
        width: 1200,
        height: 630,
        alt: 'SEO Company In Kolkata - MyDigital Crown',
      },
    ],
  },
  twitter: {
    ...
    title: 'SEO Company In Kolkata | #1 SEO Services Agency',
    description: 'Top SEO Company In Kolkata. 400+ Clients Ranked #1. 500% Traffic Growth. Expert SEO Services.',
    images: ['https://mydigitalcrown.in/images/seo-company-kolkata.jpg'],
  ...
  alternates: {
    canonical: 'https://mydigitalcrown.in/kolkata/search-engine-optimisation',
  },
  verification: {
...
export default function SEO() {
  ...
  const schemaData = {
    ...
    "@graph": [
      // 1. Service Schema
      {
        "@type": "Service",
        "name": "SEO Services",
        "description": "Professional Search Engine Optimization services in Kolkata delivering 500% traffic growth and #1 Google rankings",
        "provider": {
          "@type": "Organization",
      ...
      // 2. Organization Schema
      {
        ...
        "description": "Kolkata's #1 SEO Company delivering 500% traffic growth for 400+ clients",
        "address": {
          "@type": "PostalAddress",
      ...
      {
        "@type": "WebPage",
        "name": "SEO Company In Kolkata | #1 SEO Services Agency",
        "description": "Top SEO Company In Kolkata. 400+ Clients Ranked #1. 500% Traffic Growth. Expert SEO Services.",
        "url": "https://mydigitalcrown.in/kolkata/search-engine-optimisation",
        "inLanguage": "en-IN",
        "isPartOf": {
        ...
        "keywords": "seo company in kolkata, seo services kolkata, seo agency kolkata, best seo company kolkata"
      },
      // 4. BreadcrumbList Schema
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": "SEO Services",
            "item": "https://mydigitalcrown.in/kolkata/search-engine-optimisation"
          }
        ]
      },
      // 5. FAQPage Schema
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What SEO services does your Kolkata company provide?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We provide comprehensive SEO services including on-page optimization, off-page link building, technical SEO audits, local SEO for Kolkata businesses, content strategy, keyword research, competitor analysis, and monthly performance reporting. Our services are customized to your business goals and industry competition."
            }
          },
          {
            "@type": "Question",
            "name": "How much do your SEO services cost in Kolkata?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Can you help with local SEO for Kolkata businesses?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutely! Local SEO is one of our specialties. We optimize Google Business Profile, build local citations, create location-specific content, earn local backlinks, and implement schema markup for local businesses. We help Kolkata businesses dominate local search results and Google Maps rankings in their service areas."
            }
          }
        ]
      },
      // 6. ItemList Schema (Services)
      {
        ...
        "description": "Comprehensive SEO services for Kolkata businesses",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
      ...
      {
        "@type": "Article",
        "headline": "Complete Guide to SEO Company Services in Kolkata",
        "description": "Comprehensive guide to choosing and working with the best SEO company in Kolkata",
        "author": {
          "@type": "Organization",
          "name": "MyDigital Crown"
        },
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://mydigitalcrown.in/kolkata/search-engine-optimisation"
        },
        "image": "https://mydigitalcrown.in/images/seo-company-kolkata.jpg"
      },
      // 10. LocalBusiness Schema
      {
        "@type": "LocalBusiness",
        "name": "MyDigital Crown - SEO Company Kolkata",
        "description": "Kolkata's leading SEO company delivering 500% traffic growth",
        "url": "https://mydigitalcrown.in",
        "telephone": "+91-83695-11877",
      ...
      {
        "@type": "VideoObject",
        "name": "How SEO Company Services Work in Kolkata",
        "description": "Learn how our SEO company delivers results for Kolkata businesses",
      ...
      // 12. Course Schema
      {
        ...
        "description": "Learn advanced SEO strategies from Kolkata's top SEO company",
        "provider": {
          "@type": "Organization",
          "name": "MyDigital Crown"
        },
      ...
      // 13. SpecialAnnouncement Schema
      {
        ...
        "name": "Free SEO Audit for Kolkata Businesses",
      ...
      // 15. Offer Schema
      {
        ...
        "description": "Professional SEO services for Kolkata businesses",
        "price": "15000",
        "priceCurrency": "INR",
        "availability": "https://schema.org/InStock",
        "url": "https://mydigitalcrown.in/kolkata/search-engine-optimisation",
  ...
  return (
    <>
      ...
      <noscript>
        <div>
          <p>MyDigital Crown - SEO Company In Kolkata</p>
          <p>Top SEO Company In Kolkata. 400+ Clients Ranked #1. 500% Traffic Growth.</p>
          <p>Call: +91-83695-11877 | Email: info@mydigitalcrown.in</p>
          <p>Address: Chembur, Kolkata, West Bengal - 700001</p>
        </div>
      </noscript>
      ...
      <section 
        ...
        aria-label="Search Engine Optimization Kolkata Hero Section"
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-3 mb-6 shadow-xl">
                ...
                <span className="text-white font-semibold">Kolkata&apos;s #1 SEO Company</span>
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              </div>
              
              {/* Main Heading */}
              <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight text-center">
                SEO Company In Kolkata - MyDigital Crown
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Quick Answers About SEO Company In Kolkata
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Where is the best SEO company in Kolkata?</h3>
              <p className="text-blue-100 leading-relaxed">
                MyDigital Crown is Kolkata&apos;s leading SEO company with offices in Chembur, Andheri, Bandra, Powai, and Thane. We serve clients across Kolkata, Navi Kolkata, and Thane with expert SEO services that deliver real results.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              <div className="text-4xl mb-4">💰</div>
              <h3 className="text-2xl font-bold text-white mb-4">How much do SEO services cost in Kolkata?</h3>
              <p className="text-blue-100 leading-relaxed">
                Professional SEO services in Kolkata range from ₹15,000/month for small businesses to ₹1,00,000+/month for enterprise solutions. Pricing depends on competition, website size, and business goals. We offer custom packages to fit every budget.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-500/20 to-orange-500/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">When will I see SEO results in Kolkata?</h3>
              <p className="text-blue-100 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Get answers to the most common questions about our SEO company and services in Kolkata
            </p>
          </div>
              ...
              <summary className="cursor-pointer list-none p-8 flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-blue-300 transition-colors">
                    What SEO services does your Kolkata company provide?
                  </h3>
                </div>
              ...
              <summary className="cursor-pointer list-none p-8 flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-purple-300 transition-colors">
                    How much do your SEO services cost in Kolkata?
                  </h3>
                </div>
              ...
              <summary className="cursor-pointer list-none p-8 flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-cyan-300 transition-colors">
                    Can you help with local SEO for Kolkata businesses?
                  </h3>
                </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
                Understanding <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">SEO Company Services</span> in Kolkata
              </h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Search Engine Optimization has become the cornerstone of digital marketing success for Kolkata businesses. As an established SEO company serving Kolkata&apos;s diverse business landscape, we understand that effective SEO is not just about rankings—it&apos;s about driving qualified traffic, converting visitors into customers, and building sustainable online growth.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-pink-900/40 to-red-900/40 backdrop-blur-sm rounded-2xl p-8 border border-pink-500/20 hover:border-pink-400/40 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Unlike short-term marketing tactics, SEO builds compound value over time. Our Kolkata SEO company focuses on sustainable strategies that create lasting competitive advantages. We prioritize building authoritative content, earning quality backlinks, and establishing your website as a trusted industry resource that maintains top rankings for years.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-600/10 to-pink-600/10 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4">
                      On-page optimization ensures every element of your web pages is perfectly aligned with search engine requirements and user expectations. Our SEO company in Kolkata meticulously optimizes title tags, meta descriptions, header tags (H1-H6), and URL structures for maximum keyword relevance. We strategically place keywords in content while maintaining natural readability and user value.
                    </p>
                    <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-4">Local SEO for Kolkata Businesses</h3>
                    <p className="text-gray-300 leading-relaxed mb-4">
                      For businesses serving Kolkata customers, local SEO is critical. We optimize Google Business Profiles with accurate information, compelling descriptions, and regular posts. We build local citations across directories, optimize for &quot;near me&quot; searches, create location-specific landing pages, and implement local schema markup.
                    </p>
                    <p className="text-gray-300 leading-relaxed">
                      Our local SEO strategies help Kolkata businesses dominate Google Maps results, appear in the Local Pack for relevant searches, and attract customers searching for services in specific Kolkata neighborhoods like Andheri, Bandra, Powai, Chembur, and Thane. We manage reviews, respond to customer feedback, and build local authority that drives foot traffic and phone calls.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
                Why Kolkata Businesses <span className="bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent">Choose Us</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Our track record of delivering measurable results for 400+ clients across industries sets us apart as Kolkata&apos;s premier SEO company.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Over 12 years delivering measurable SEO results for Kolkata businesses across e-commerce, professional services, healthcare, real estate, and technology sectors.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Deep understanding of Kolkata&apos;s competitive landscape, local search behavior, and market dynamics that inform effective SEO strategies.</p>
                  </div>
                </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                We follow a systematic, data-driven approach that ensures consistent results and continuous improvement for our Kolkata clients.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed ml-16">
                  Our Kolkata SEO team executes the strategy through technical fixes, on-page optimization, content creation, and link building campaigns. We implement changes methodically, testing and refining approaches based on performance data and algorithm updates.
                </p>
              </div>
          ...
          <div className="bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-3xl p-12 border border-blue-500/30">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
                Partner with Kolkata&apos;s leading SEO company to drive organic traffic, generate qualified leads, and achieve sustainable business growth through search engine optimization.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-10">
              ...
              <div className="text-center">
                ...
                <p className="text-blue-200">Chembur, Kolkata</p>
              </div>
            </div>
      ...
      {/* Related Services */}
      <RelatedServices 
        currentService="/kolkata/search-engine-optimisation"
