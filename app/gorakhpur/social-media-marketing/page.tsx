...
export const metadata = {
  title: "Social Media Marketing Gorakhpur | SMM Agency | MyDigital",
  description: "Social Media Marketing Company Gorakhpur. 1000+ Campaigns | 50M+ Reach | Facebook, Instagram & LinkedIn Experts. Call +91-83695-11877",
  keywords: [
    // Primary Keywords
    "Social Media marketing company in Gorakhpur", "social media marketing Gorakhpur", "SMM company Gorakhpur", "social media agency Gorakhpur", "social media services Gorakhpur",
    // Quality Keywords
    "best social media company Gorakhpur", "top SMM agency Gorakhpur", "professional social media marketing Gorakhpur", "expert social media services Gorakhpur", "certified SMM company Gorakhpur",
    // Platform-Specific Keywords
    "Facebook marketing Gorakhpur", "Instagram marketing Gorakhpur", "LinkedIn marketing Gorakhpur", "Twitter marketing Gorakhpur", "YouTube marketing Gorakhpur",
    "TikTok marketing Gorakhpur", "Pinterest marketing Gorakhpur", "social media advertising Gorakhpur", "social media management Gorakhpur", "social media strategy Gorakhpur",
    // Service-Specific Keywords
    "social media content creation Gorakhpur", "social media optimization Gorakhpur", "social media campaign Gorakhpur", "influencer marketing Gorakhpur", "community management Gorakhpur",
    "social media analytics Gorakhpur", "paid social advertising Gorakhpur", "organic social media Gorakhpur", "social media branding Gorakhpur", "social media consulting Gorakhpur",
    // Business Keywords
    "affordable SMM Gorakhpur", "social media packages Gorakhpur", "social media ROI Gorakhpur", "social media growth Gorakhpur", "social media marketing consultant Gorakhpur",
    "B2B social media marketing Gorakhpur", "social media for business Gorakhpur"
  ],
  ...
  openGraph: {
    title: 'Social Media marketing company in Gorakhpur | #1 SMM Agency 2025',
    description: 'Leading Social Media marketing company in Gorakhpur with 1000+ campaigns, 50M+ reach & proven ROI. Expert Facebook, Instagram, LinkedIn marketing services.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Social Media marketing company in Gorakhpur - MyDigital Crown',
      },
    ],
    locale: 'en_IN',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Social Media marketing company in Gorakhpur | #1 SMM Agency 2025',
    description: 'Leading Social Media marketing company in Gorakhpur with 1000+ campaigns, 50M+ reach & proven ROI.',
    images: ['https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=1200&h=630&fit=crop'],
  },
  alternates: {
    canonical: 'https://mydigitalcrown.in/gorakhpur/social-media-marketing',
  },
  robots: {
    index: true,
    follow: true,
  ...
  "@graph": [
    {
      ...
      "description": "Leading Social Media marketing company in Gorakhpur providing expert SMM services",
      "address": {
        "@type": "PostalAddress",
    ...
    {
      "@type": "Service",
      "serviceType": "Social Media marketing company in Gorakhpur",
      "provider": {
        "@type": "Organization",
        "name": "MyDigital Crown"
      },
      ...
      "description": "Professional Social Media marketing company in Gorakhpur offering Facebook, Instagram, LinkedIn, Twitter marketing services with 1000+ campaigns and 50M+ reach",
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
    ...
    {
      "@type": "LocalBusiness",
      "name": "MyDigital Crown - Social Media marketing company in Gorakhpur",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is Social Media marketing company in Gorakhpur?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A Social Media marketing company in Gorakhpur specializes in managing and growing your brand's presence across social media platforms like Facebook, Instagram, LinkedIn, Twitter, YouTube, and TikTok through strategic content creation, paid advertising, community engagement, influencer partnerships, and data-driven campaigns that drive business growth and measurable ROI."
          }
        },
        {
          "@type": "Question",
          "name": "How much does Social Media marketing cost in Gorakhpur?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Social media marketing costs in Gorakhpur vary based on services, platforms, and campaign scope. Our Social Media marketing company in Gorakhpur offers customized packages: Starter ₹15,000-₹25,000/month, Growth ₹30,000-₹50,000/month, Premium ₹60,000-₹1,00,000/month, and Enterprise custom solutions with flexible pricing based on your specific business needs."
          }
        },
        {
          "@type": "Question",
          "name": "Why choose a professional Social Media marketing company in Gorakhpur?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A professional Social Media marketing company in Gorakhpur brings expertise in platform algorithms, creative content production, paid advertising optimization, advanced analytics, community management, influencer marketing, crisis management, and proven strategies that deliver measurable ROI, brand growth, and competitive advantage in the digital marketplace."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most businesses see initial engagement improvements within 2-4 weeks. Significant growth in followers, engagement, and conversions typically occurs within 3-6 months with consistent strategy execution. Our Social Media marketing company in Gorakhpur provides monthly performance reports tracking progress toward your specific KPIs and business objectives."
          }
        },
        {
          "@type": "Question",
          "name": "What services does your Social Media marketing company in Gorakhpur offer?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! Our Social Media marketing company in Gorakhpur has an in-house team of graphic designers, video editors, copywriters, and content strategists who create high-quality, engaging content tailored to each platform. We produce custom graphics, videos, reels, stories, carousel posts, and written content aligned with your brand identity with approval workflows."
          }
        },
        {
          "@type": "Question",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Social Media marketing company in Gorakhpur",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight text-center">
                Social Media Marketing Company In Gorakhpur - MyDigital Crown
              </h1>
              ...
              <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-2 shadow-2xl">
                <div className="relative rounded-2xl overflow-hidden bg-white">
                  <Image 
                    ...
                    alt="Social Media Marketing Services Gorakhpur"
                    width={600}
                    height={600}
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Everything you need to know about professional Social Media marketing company in Gorakhpur services
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-blue-400/50">
              <summary className="cursor-pointer list-none p-6 font-bold text-lg text-white flex justify-between items-center">
                <span>What is Social Media marketing company in Gorakhpur? 📱</span>
              ...
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                A Social Media marketing company in Gorakhpur specializes in managing and growing your brand&apos;s presence across social media platforms like Facebook, Instagram, LinkedIn, Twitter, and YouTube. Our Social Media marketing company in Gorakhpur offers comprehensive services including content creation, community management, paid advertising, influencer collaborations, and analytics to help businesses build engaged audiences and drive measurable results.
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-pink-400/50">
              <summary className="cursor-pointer list-none p-6 font-bold text-lg text-white flex justify-between items-center">
                <span>How much does Social Media marketing cost in Gorakhpur? 💰</span>
                <svg className="w-6 h-6 text-blue-400 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                Social media marketing costs in Gorakhpur vary based on the platforms, services, campaign scope, and business goals. Our Social Media marketing company in Gorakhpur offers flexible packages starting from ₹15,000/month for basic management to ₹50,000+ for comprehensive multi-platform campaigns with paid advertising. We provide customized pricing based on your specific needs, audience size, content requirements, and advertising budget.
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-blue-400/50">
              <summary className="cursor-pointer list-none p-6 font-bold text-lg text-white flex justify-between items-center">
                <span>Why choose a professional Social Media marketing company in Gorakhpur? 🏆</span>
                <svg className="w-6 h-6 text-blue-400 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                A professional Social Media marketing company in Gorakhpur brings specialized expertise in platform algorithms, content strategy, creative design, paid advertising, community management, and analytics. We understand the nuances of each platform, create engaging content that resonates with your audience, manage campaigns efficiently, and deliver measurable ROI. Our Social Media marketing company in Gorakhpur has helped over 800 clients achieve significant growth through proven strategies and data-driven optimization.
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-green-400/50">
              ...
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                Initial improvements in engagement and reach typically appear within 2-4 weeks of starting with our Social Media marketing company in Gorakhpur. Significant growth in followers, engagement rates, and conversions usually becomes evident within 3-6 months of consistent strategy execution. The timeline depends on factors like your starting point, industry competition, budget, content quality, and campaign objectives. Our Social Media marketing company in Gorakhpur provides monthly reports showing progress and optimization opportunities.
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-orange-400/50">
              <summary className="cursor-pointer list-none p-6 font-bold text-lg text-white flex justify-between items-center">
                <span>What&apos;s included in Social Media marketing company in Gorakhpur services? 🎯</span>
                <svg className="w-6 h-6 text-blue-400 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                Our Social Media marketing company in Gorakhpur provides comprehensive services including strategy development, content creation (graphics, videos, copywriting), posting schedule management, community engagement, paid advertising campaigns, influencer collaborations, hashtag research, competitor analysis, monthly analytics reports, and ongoing optimization. We handle everything from creative concepting to performance tracking, ensuring your social media presence drives real business results.
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-red-400/50">
              ...
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                Our Social Media marketing company in Gorakhpur tracks comprehensive metrics including reach, impressions, engagement rate, follower growth, click-through rates, conversion rates, cost per acquisition, and ROI. We provide detailed monthly reports showing performance against goals, top-performing content, audience demographics, and actionable insights. Our transparent reporting ensures you understand exactly how social media contributes to your business objectives and revenue growth.
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-white/20 hover:border-cyan-400/50">
              ...
              <div className="px-6 pb-6 text-blue-100 leading-relaxed">
                Yes! Our Social Media marketing company in Gorakhpur has an in-house team of graphic designers, video editors, copywriters, and content strategists who create high-quality, engaging content tailored to each platform. We produce custom graphics, videos, reels, stories, carousel posts, and written content aligned with your brand identity. All content goes through approval before publishing, ensuring it meets your quality standards and brand guidelines.
              </div>
            </details>
          ...
          <div className="mt-16 text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 shadow-2xl">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Our Social Media marketing company in Gorakhpur experts are here to help!
            </p>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Why Choose Professional Social Media marketing company in Gorakhpur?
            </h2>
          </div>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-3xl font-bold text-white mb-4">What Makes Great Social Media marketing company in Gorakhpur?</h3>
                  <div className="prose prose-lg max-w-none text-blue-100 leading-relaxed space-y-4">
                    <p>
                      A professional Social Media marketing company in Gorakhpur brings specialized expertise in creating and managing campaigns that drive measurable business results across platforms like Facebook, Instagram, LinkedIn, Twitter, YouTube, and Pinterest. With over 1000 campaigns run and 50M+ people reached, our Social Media marketing company in Gorakhpur understands the complexities of content strategy, paid advertising, community management, and performance optimization.
                    </p>
                    <p>
                      The best Social Media marketing company in Gorakhpur doesn&apos;t just post content randomly. We develop data-driven strategies aligned with your business goals, target audience insights, and platform best practices. Our Social Media marketing company in Gorakhpur has helped over 800 businesses achieve significant growth through creative content, strategic campaigns, and continuous optimization that maximizes ROI.
                    </p>
                    <p>
                      What sets a leading Social Media marketing company in Gorakhpur apart is the ability to connect social media activities directly to business outcomes like leads, sales, and revenue. We implement comprehensive tracking, analytics, and reporting systems that provide clear visibility into campaign performance. Every campaign from our Social Media marketing company in Gorakhpur is backed by data, creativity, and proven strategies designed to build engaged communities and drive conversions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-white mb-4">Comprehensive Marketing Services from Social Media marketing company in Gorakhpur</h3>
                  <p className="text-gray-700 leading-relaxed mb-8">
                    Our Social Media marketing company in Gorakhpur offers end-to-end social media services covering all aspects of digital success.
                  </p>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Professional graphics, videos, and copy that stop the scroll. Our Social Media marketing company in Gorakhpur creates engaging content optimized for each platform and audience.
                      </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Expert campaign management across Facebook Ads, Instagram Ads, LinkedIn Ads, and more. The Social Media marketing company in Gorakhpur maximizes ROI through strategic targeting and optimization.
                      </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-6 border border-pink-200">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Build and nurture engaged communities. Our Social Media marketing company in Gorakhpur manages comments, messages, and interactions to strengthen customer relationships.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
              <div className="flex items-start gap-4 mb-6">
                <div className="text-5xl">📈</div>
                <div>
                  <h3 className="text-3xl font-bold text-white mb-4">Campaign Management & Optimization by Social Media marketing company in Gorakhpur</h3>
                  <div className="prose prose-lg max-w-none text-blue-100 leading-relaxed space-y-4">
                    <p>
                      Our Social Media marketing company in Gorakhpur excels at creating and managing high-performing campaigns that drive business results. We develop comprehensive campaign strategies aligned with your goals, whether it&apos;s brand awareness, lead generation, website traffic, app installs, or e-commerce sales. Our Social Media marketing company in Gorakhpur team handles everything from campaign setup and creative development to targeting, bidding, and ongoing optimization.
                    </p>
                    <p>
                      The Social Media marketing company in Gorakhpur provides expert paid advertising management across all major platforms. We leverage advanced targeting options to reach your ideal customers based on demographics, interests, behaviors, and custom audiences. Our Social Media marketing company in Gorakhpur continuously tests and optimizes ad creatives, targeting parameters, ad placements, and bidding strategies to maximize ROI while minimizing cost per acquisition.
                    </p>
                    <p>
                      As a results-focused Social Media marketing company in Gorakhpur provider, we implement comprehensive tracking and analytics to measure campaign performance accurately. We track metrics like reach, impressions, engagement, clicks, conversions, and revenue attribution. Our transparent reporting shows exactly how social media marketing contributes to your business goals. The Social Media marketing company in Gorakhpur has helped businesses achieve 300% average ROI increase through strategic campaign management and data-driven optimization.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
              <div className="flex items-start gap-4 mb-6">
                <div className="text-5xl">💡</div>
                <div>
                  <h3 className="text-3xl font-bold text-white mb-4">Creative Content & Strategy by Social Media marketing company in Gorakhpur</h3>
                  <div className="prose prose-lg max-w-none text-blue-100 leading-relaxed space-y-4">
                    <p>
                      A professional Social Media marketing company in Gorakhpur creates content that captures attention, drives engagement, and inspires action. We develop comprehensive content strategies covering themes, formats, posting schedules, and distribution plans. Our Social Media marketing company in Gorakhpur produces high-quality graphics, videos, reels, stories, carousel posts, and written content tailored to each platform&apos;s requirements and your brand identity.
                    </p>
                    <p>
                      The Social Media marketing company in Gorakhpur includes experienced graphic designers, video editors, copywriters, and content strategists who collaborate to create scroll-stopping content. We conduct audience research to understand what resonates with your target customers, analyze competitor content for opportunities, and stay updated on trending formats and viral techniques. Our Social Media marketing company in Gorakhpur ensures consistent brand voice and visual identity across all platforms while adapting content for each channel&apos;s unique requirements.
                    </p>
                    <p>
                      Our Social Media marketing company in Gorakhpur also provides community management, influencer marketing, user-generated content campaigns, and social listening services. We monitor brand mentions, engage with followers, respond to comments and messages, manage customer service inquiries, and identify opportunities for engagement. The insights from our Social Media marketing company in Gorakhpur help you build authentic relationships with customers, turn followers into brand advocates, and create loyal communities that drive word-of-mouth growth.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-pink-600 rounded-3xl p-12 shadow-2xl text-white">
              <div className="flex items-start gap-4 mb-8">
                <div className="text-5xl">🏆</div>
                <div className="flex-1">
                  <h3 className="text-3xl md:text-4xl font-bold mb-4">Why MyDigital Crown is the Best Social Media marketing company in Gorakhpur?</h3>
                  <p className="text-blue-100 text-lg leading-relaxed mb-8">
                    As Gorakhpur&apos;s leading Social Media marketing company in Gorakhpur provider, we deliver exceptional results through expert strategy, creative content, and data-driven optimization.
                  </p>
            ...
            <div className="text-center bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl p-12">
              <h3 className="text-3xl font-bold text-white mb-4">
                Ready to Work with the Best Social Media marketing company in Gorakhpur?
              </h3>
