...
export const metadata = {
  title: 'Digital Marketing Services Near Me in Thiruvananthapuram | #1 Agency',
  description: 'Digital Marketing Services Near Me in Thiruvananthapuram. 150+ Brands Served | 300% ROI | SEO, Social Media, Web Development, AI/ML Services. Call +91-83695-11877',
  keywords: [
    // Primary Keywords (5)
    'digital marketing services near me in thiruvananthapuram',
    'digital marketing company in thiruvananthapuram',
    'digital marketing agency thiruvananthapuram',
    'best digital marketing services thiruvananthapuram',
    'top digital marketing company thiruvananthapuram',
    
    // Location-based Keywords (8)
    'digital marketing thiruvananthapuram kerala',
    'thiruvananthapuram digital marketing services',
    'digital marketing near thiruvananthapuram',
    'local digital marketing thiruvananthapuram',
    'digital marketing consultant thiruvananthapuram',
    'thiruvananthapuram based digital marketing company',
    'digital marketing experts thiruvananthapuram',
    'professional digital marketing thiruvananthapuram',
    
    // Service-specific Keywords (12)
    'seo services thiruvananthapuram',
    'social media marketing thiruvananthapuram',
    'web development thiruvananthapuram',
    'digital branding thiruvananthapuram',
    'youtube marketing thiruvananthapuram',
    'complete digital marketing thiruvananthapuram',
    'artificial intelligence services thiruvananthapuram',
    'machine learning thiruvananthapuram',
    'google ads thiruvananthapuram',
    'ppc services thiruvananthapuram',
    'content marketing thiruvananthapuram',
    'email marketing thiruvananthapuram',
    
    // Long-tail Keywords (8)
    'digital marketing services for small business thiruvananthapuram',
    'affordable digital marketing thiruvananthapuram',
    'result oriented digital marketing thiruvananthapuram',
    'roi focused digital marketing thiruvananthapuram',
    'comprehensive digital marketing solutions thiruvananthapuram',
    'integrated digital marketing services thiruvananthapuram',
    'full service digital marketing agency thiruvananthapuram',
    'digital transformation services thiruvananthapuram',
    
    // Voice Search Keywords (6)
    'digital marketing company near me thiruvananthapuram',
    'best digital marketing agency around thiruvananthapuram',
    'who provides digital marketing in thiruvananthapuram',
    'digital marketing services close to me',
    'find digital marketing company thiruvananthapuram',
    'digital marketing help thiruvananthapuram',
    
    // LSI Keywords (8)
    'online marketing thiruvananthapuram',
    'internet marketing thiruvananthapuram',
    'digital advertising thiruvananthapuram',
    'online promotion thiruvananthapuram',
    'digital growth thiruvananthapuram',
    'online business development thiruvananthapuram',
    'digital strategy thiruvananthapuram',
    'online brand building thiruvananthapuram'
  ],
  authors: [{ name: 'Aditya Pandey', url: 'https://mydigitalcrown.in/about' }],
  creator: 'MyDigital Crown',
  publisher: 'MyDigital Crown',
  category: 'Digital Marketing Services',
  classification: 'Digital Marketing & Technology Services',
  verification: {
  ...
  openGraph: {
    title: 'Digital Marketing Services Near Me in Thiruvananthapuram | #1 Agency 2025',
    description: 'Leading Digital Marketing Services Near Me in Thiruvananthapuram with 150+ brands served, 300% ROI guarantee. Expert SEO, Social Media, Web Development, AI/ML services.',
    url: 'https://mydigitalcrown.in/thiruvananthapuram',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Digital Marketing Services Near Me in Thiruvananthapuram - MyDigital Crown',
      },
    ],
    locale: 'en_IN',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Digital Marketing Services Near Me in Thiruvananthapuram | #1 Agency 2025',
    description: 'Leading Digital Marketing Services Near Me in Thiruvananthapuram with 150+ brands served, 300% ROI guarantee.',
    images: ['https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=630&fit=crop'],
    creator: '@mydigitalcrown',
    site: '@mydigitalcrown',
  },
  alternates: {
    canonical: 'https://mydigitalcrown.in/thiruvananthapuram',
  },
  robots: {
    index: true,
    follow: true,
...
export default function Home() {
    ...
    '@graph': [
      {
        ...
        alternateName: 'MyDigital Crown - Digital Marketing Company Thiruvananthapuram',
        ...
        description: 'Leading Digital Marketing Company in Thiruvananthapuram offering comprehensive digital marketing services including SEO, Google Ads, Social Media Marketing, and Web Development.',
        founder: {
          '@type': 'Person',
          name: 'Aditya',
      ...
      },
      {
        ...
        name: 'MyDigital Crown - Digital Marketing Company Thiruvananthapuram',
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'SEO Services Thiruvananthapuram',
                description: 'Search Engine Optimization services to rank higher on Google',
                url: 'https://mydigitalcrown.in/thiruvananthapuram/search-engine-optimisation'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                '@type': 'Service',
                name: 'Social Media Marketing Thiruvananthapuram',
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Google Ads Management Thiruvananthapuram',
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Web Development Thiruvananthapuram',
                description: 'Professional website development and design services',
                url: 'https://mydigitalcrown.in/thiruvananthapuram/web-development'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                url: 'https://mydigitalcrown.in/thiruvananthapuram/digital-branding'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                url: 'https://mydigitalcrown.in/thiruvananthapuram/youtube-promotion'
              }
            }
          ]
        },
      ...
      },
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'What is the best digital marketing company in Thiruvananthapuram?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'MyDigital Crown is one of the leading digital marketing companies in Thiruvananthapuram, offering 50+ services including SEO, Google Ads, Social Media Marketing, and Web Development with 8+ years of experience and 150+ satisfied clients.'
            }
          },
          {
            '@type': 'Question',
            name: 'How much does digital marketing cost in Thiruvananthapuram?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Digital marketing costs in Thiruvananthapuram vary based on services. At MyDigital Crown, we offer customized packages starting from ₹15,000/month for SEO to ₹50,000/month for comprehensive digital marketing solutions.'
            }
          },
          {
            '@type': 'Question',
            name: 'Which digital marketing agency is best in Thiruvananthapuram?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'MyDigital Crown is recognized as one of the best digital marketing agencies in Thiruvananthapuram, providing result-driven strategies with a proven track record of 300% average ROI for clients.'
            }
          }
        ]
      },
      ...
      },
      {
        ...
        url: 'https://mydigitalcrown.in',
        name: 'MyDigital Crown - Digital Marketing Company Thiruvananthapuram',
        description: 'Leading Digital Marketing Company in Thiruvananthapuram offering SEO, Social Media Marketing, Google Ads, Web Development & 50+ Digital Marketing Services',
        publisher: {
          '@id': 'https://mydigitalcrown.in/#organization'
        },
        potentialAction: [
  ...
  return (
    <>
      ...
      {/* Hero Section - Main Content for Digital Marketing Company in Thiruvananthapuram */}
      <section 
        className="pt-16 py-16 bg-gradient-to-br from-blue-800 to-blue-600 relative overflow-hidden"
        itemScope 
        itemType="https://schema.org/Organization"
        aria-label="Digital Marketing Company Thiruvananthapuram Hero Section"
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-3 mb-6 shadow-xl">
                ...
                <span className="text-white font-semibold" itemProp="slogan">Thiruvananthapuram&apos;s Leading Digital Marketing Company</span>
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              </div>
              ...
              <h1 
                ...
                itemProp="name"
              >
                Digital Marketing Services Near Me in Thiruvananthapuram | #1 Agency
              </h1>
              ...
              <div className="mb-10" itemProp="description">
                <h2 className="text-2xl md:text-3xl text-white mb-6 max-w-4xl mx-auto text-center font-bold leading-relaxed">
                  🎯 Accelerate Your Business Growth with <span className="text-yellow-300">200+ Successful Projects</span>, <span className="text-green-300">Proven Track Record</span> & <span className="text-orange-300">500% ROI Guarantee</span>
                </h2>
                <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto text-center font-semibold leading-relaxed">
                  Complete Digital Solutions | Search Optimization | PPC Campaigns | Social Engagement | Custom Development
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                <Link 
                  ...
                  title="Get Free Digital Marketing Consultation Thiruvananthapuram"
                  aria-label="Contact best digital marketing company in Thiruvananthapuram for free audit"
                >
                ...
                <a 
                  ...
                  title="Call Best Digital Marketing Agency Thiruvananthapuram"
                  aria-label="Call MyDigital Crown - Top Digital Marketing Company Thiruvananthapuram"
                >
                  <span className="relative z-10 flex items-center gap-3">
      ...
      {/* About Us Section - Digital Marketing Consultants Thiruvananthapuram */}
      <section 
        className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden"
        aria-label="About MyDigital Crown - Digital Marketing Agency Thiruvananthapuram"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <header className="text-center mb-16">
            <div className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg">
              ...
              Discover MyDigital Crown - Premier Digital Growth Experts in Thiruvananthapuram
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              What Makes MyDigital Crown Your <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Ideal Digital Success Partner</span> in Thiruvananthapuram?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              <strong>Searching for reliable digital growth specialists in Thiruvananthapuram?</strong> We&apos;re a pioneering digital excellence agency in Thiruvananthapuram empowering businesses through cutting-edge digital transformation strategies since our inception
            </p>
          </header>
              ...
              <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-2 shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                <div className="relative rounded-2xl overflow-hidden bg-white">
                  <Image 
                    ...
                    alt="Aditya Pandey - Founder & Digital Marketing Consultant Thiruvananthapuram | Best Digital Marketing Company"
                    width={600}
                    height={700}
                    className="w-full h-auto object-cover"
                    priority
                    title="Aditya Pandey - Digital Marketing Expert Thiruvananthapuram"
                  />
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Welcome to <span className="font-bold text-blue-600">MyDigital Crown</span> - Thiruvananthapuram&apos;s premier digital marketing agency founded by <span className="font-bold">Aditya Pandey</span>. With over 8 years of industry experience, we&apos;ve helped 50+ businesses achieve remarkable growth through innovative digital marketing strategies.
                </p>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-6 text-white">
                <h4 className="text-xl font-bold mb-4 flex items-center">
                  ...
                  What Sets MyDigital Crown Apart?
                </h4>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Proven 500% ROI enhancement track record</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>Comprehensive digital transformation solutions</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>Tailored approaches for maximum business impact</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>Personal success manager & round-the-clock assistance</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  ...
                  title="Learn About Thiruvananthapuram&apos;s Best Digital Marketing Company"
                  aria-label="Learn more about MyDigital Crown - Top Digital Marketing Agency Thiruvananthapuram"
                >
                  <span className="relative flex items-center">
                    <span className="mr-2">📖</span>
                    Learn About Best Digital Marketing Company Thiruvananthapuram
                  </span>
                </Link>
                <Link 
                  href="/contact" 
                  ...
                  title="Contact Digital Marketing Agency Thiruvananthapuram - Free Consultation"
                  aria-label="Contact MyDigital Crown for Digital Marketing Services Thiruvananthapuram"
                >
      ...
      {/* Services Section - Digital Marketing Services Thiruvananthapuram */}
      <section 
        className="py-20 bg-white relative overflow-hidden"
        aria-label="Digital Marketing Services in Thiruvananthapuram"
        itemScope 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <header className="text-center mb-16">
            <div className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full text-base font-bold mb-8 shadow-xl hover:shadow-2xl transition-all">
              ...
              <span>Comprehensive Digital Solutions Portfolio</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-8 leading-tight" itemProp="name">
              <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Complete Solutions</span>
              <br />
              <span className="text-4xl md:text-5xl text-gray-800">For Digital Excellence</span>
            </h2>
            <p className="text-2xl text-gray-700 max-w-4xl mx-auto font-semibold mb-4" itemProp="description">
              From <span className="text-blue-600">Search Optimization</span> to <span className="text-purple-600">Social Engagement</span>, <span className="text-pink-600">PPC Campaigns</span> to <span className="text-orange-600">Custom Development</span>
            </p>
            <p className="text-lg text-gray-500 max-w-3xl mx-auto">
              Your complete toolkit for digital market domination 🎯
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Service 1: SEO */}
            <Link href="/thiruvananthapuram/search-engine-optimisation" className="group relative rounded-3xl overflow-hidden border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=800&h=600&fit=crop"
                  alt="SEO Services Thiruvananthapuram - Digital Marketing Company | Search Engine Optimization Agency"
                  fill
            ...
            <Link href="/thiruvananthapuram/social-media-marketing" className="group relative rounded-3xl overflow-hidden border-2 border-pink-200 hover:border-pink-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&h=600&fit=crop"
                  alt="Social Media Marketing Thiruvananthapuram - Best Digital Marketing Agency | Instagram Facebook LinkedIn Marketing"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/services/google-ads" className="group relative rounded-3xl overflow-hidden border-2 border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="Google Ads PPC Thiruvananthapuram - Digital Marketing Company | Pay Per Click Advertising Agency"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/thiruvananthapuram/web-development" className="group relative rounded-3xl overflow-hidden border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop"
                  alt="Web Development Thiruvananthapuram - Digital Marketing Company | Custom Website Development Agency"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/thiruvananthapuram/digital-branding" className="group relative rounded-3xl overflow-hidden border-2 border-indigo-200 hover:border-indigo-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
            ...
            <Link href="/thiruvananthapuram/youtube-promotion" className="group relative rounded-3xl overflow-hidden border-2 border-rose-200 hover:border-rose-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
            ...
            <Link href="/thiruvananthapuram/artificial-intelligence" className="group relative rounded-3xl overflow-hidden border-2 border-violet-200 hover:border-violet-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
            ...
            <Link href="/thiruvananthapuram/machine-learning" className="group relative rounded-3xl overflow-hidden border-2 border-emerald-200 hover:border-emerald-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              What Thiruvananthapuram <span className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent">Businesses</span><br />
              Say About Us
            </h2>
            
            <p className="text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed">
              Real results, real clients, real growth stories from Thiruvananthapuram&apos;s most successful businesses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl">
              ...
              <div className="mb-6">
                ...
                <blockquote className="text-lg text-white/90 leading-relaxed italic">
                  &quot;Our cleaning service flourished after partnering with MyDigital Crown. Their local SEO strategies helped us dominate Thiruvananthapuram&apos;s market. We now get <span className="text-cyan-400 font-bold">50+ inquiries weekly</span>. Outstanding team!&quot;
                </blockquote>
              </div>
              <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              MyDigital Crown serves clients across India with our main offices strategically located in Thiruvananthapuram, Varanasi, and Bangalore. Visit us for personalized digital marketing consultations and discover why we&apos;re recognized as a top digital marketing company.
            </p>
            ...
            <div className="group">
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Thiruvananthapuram Office</h3>
          ...
          <div className="text-center mt-16">
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-12 shadow-2xl border border-white/50 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Schedule a free consultation with our digital marketing experts at any of our three locations - Thiruvananthapuram, Varanasi, or Bangalore. We&apos;re here to help transform your business with data-driven strategies.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-blue-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Everything you need to know about digital marketing services in Thiruvananthapuram ✨
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-orange-500/20 hover:border-orange-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-orange-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>What makes MyDigital Crown the best digital marketing company in Thiruvananthapuram?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p>MyDigital Crown stands out as Thiruvananthapuram&apos;s premier digital marketing agency with 8+ years of experience, 150+ happy clients, and a proven track record of delivering 300% average growth. We offer 50+ specialized services including SEO, Google Ads, social media marketing, web development, and more. Our data-driven strategies, 24/7 support, and commitment to measurable results make us the preferred choice for businesses in Thiruvananthapuram looking to dominate their digital landscape.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-blue-500/20 hover:border-blue-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-blue-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>What digital marketing services do you offer in Thiruvananthapuram?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-green-500/20 hover:border-green-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-green-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>How much does digital marketing cost in Thiruvananthapuram?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-yellow-500/20 hover:border-yellow-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-yellow-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-bounce">📍</span>
                  <span>Do you provide local SEO services for Thiruvananthapuram-based businesses?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p className="mb-4">Yes! We specialize in local SEO for Thiruvananthapuram businesses. Our local SEO services include:</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">✅ Google Business Profile optimization and management</li>
                  <li className="flex items-start gap-2">✅ Local keyword research and targeting (Thiruvananthapuram-specific)</li>
                  ...
                  <li className="flex items-start gap-2">✅ Map pack optimization for Thiruvananthapuram searches</li>
                </ul>
                <p className="mt-4">We help your business dominate local search results when potential customers in Thiruvananthapuram search for your services.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-pink-500/20 hover:border-pink-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-pink-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-pulse">🚀</span>
                  <span>Can you help my small business compete with larger companies in Thiruvananthapuram?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">📍 Local SEO to dominate specific Thiruvananthapuram neighborhoods</li>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-cyan-500/20 hover:border-cyan-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-cyan-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-spin">🏢</span>
                  <span>What industries do you serve in Thiruvananthapuram?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p className="mb-4">We serve businesses across all major industries in Thiruvananthapuram including:</p>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-red-500/20 hover:border-red-300/50 hover:scale-105">
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <p className="mt-4">Our social media experts create engaging content, manage communities, run targeted ad campaigns, and provide detailed analytics to grow your brand presence in Thiruvananthapuram and beyond.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-teal-500/20 hover:border-teal-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-teal-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-bounce">🌐</span>
                  <span>Can you help with website design and development in Thiruvananthapuram?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-rose-500/20 hover:border-rose-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-rose-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-pulse">⭐</span>
                  <span>What sets your digital marketing agency apart from others in Thiruvananthapuram?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">📍 <strong>Local Thiruvananthapuram Expertise:</strong> Deep understanding of Thiruvananthapuram&apos;s market dynamics</li>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore exciting career opportunities and grow with Thiruvananthapuram&apos;s leading digital marketing agency
            </p>
          </div>
