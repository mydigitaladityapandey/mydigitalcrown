...
export const metadata = {
  title: 'Digital Marketing Services Near Me in Udaipur | #1 Agency',
  description: 'Digital Marketing Services Near Me in Udaipur. 150+ Brands Served | 300% ROI | SEO, Social Media, Web Development, AI/ML Services. Call +91-83695-11877',
  keywords: [
    // Primary Keywords (5)
    'digital marketing services near me in udaipur',
    'digital marketing company in udaipur',
    'digital marketing agency udaipur',
    'best digital marketing services udaipur',
    'top digital marketing company udaipur',
    
    // Location-based Keywords (8)
    'digital marketing udaipur rajasthan',
    'udaipur digital marketing services',
    'digital marketing near udaipur',
    'local digital marketing udaipur',
    'digital marketing consultant udaipur',
    'udaipur based digital marketing company',
    'digital marketing experts udaipur',
    'professional digital marketing udaipur',
    
    // Service-specific Keywords (12)
    'seo services udaipur',
    'social media marketing udaipur',
    'web development udaipur',
    'digital branding udaipur',
    'youtube marketing udaipur',
    'complete digital marketing udaipur',
    'artificial intelligence services udaipur',
    'machine learning udaipur',
    'google ads udaipur',
    'ppc services udaipur',
    'content marketing udaipur',
    'email marketing udaipur',
    
    // Long-tail Keywords (8)
    'digital marketing services for small business udaipur',
    'affordable digital marketing udaipur',
    'result oriented digital marketing udaipur',
    'roi focused digital marketing udaipur',
    'comprehensive digital marketing solutions udaipur',
    'integrated digital marketing services udaipur',
    'full service digital marketing agency udaipur',
    'digital transformation services udaipur',
    
    // Voice Search Keywords (6)
    'digital marketing company near me udaipur',
    'best digital marketing agency around udaipur',
    'who provides digital marketing in udaipur',
    'digital marketing services close to me',
    'find digital marketing company udaipur',
    'digital marketing help udaipur',
    
    // LSI Keywords (8)
    'online marketing udaipur',
    'internet marketing udaipur',
    'digital advertising udaipur',
    'online promotion udaipur',
    'digital growth udaipur',
    'online business development udaipur',
    'digital strategy udaipur',
    'online brand building udaipur'
  ],
  ...
  openGraph: {
    title: 'Digital Marketing Services Near Me in Udaipur | #1 Agency 2025',
    description: 'Leading Digital Marketing Services Near Me in Udaipur with 150+ brands served, 300% ROI guarantee. Expert SEO, Social Media, Web Development, AI/ML services.',
    url: 'https://mydigitalcrown.in/udaipur',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Digital Marketing Services Near Me in Udaipur - MyDigital Crown',
      },
    ],
    locale: 'en_IN',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Digital Marketing Services Near Me in Udaipur | #1 Agency 2025',
    description: 'Leading Digital Marketing Services Near Me in Udaipur with 150+ brands served, 300% ROI guarantee.',
    images: ['https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=630&fit=crop'],
    creator: '@mydigitalcrown',
    site: '@mydigitalcrown',
  },
  alternates: {
    canonical: 'https://mydigitalcrown.in/udaipur',
  },
  robots: {
    index: true,
    follow: true,
...
export default function Home() {
    ...
    '@graph': [
      {
        ...
        alternateName: 'MyDigital Crown - Digital Marketing Company Udaipur',
        ...
        description: 'Leading Digital Marketing Company in Udaipur offering comprehensive digital marketing services including SEO, Google Ads, Social Media Marketing, and Web Development.',
        founder: {
          '@type': 'Person',
          name: 'Aditya',
      ...
      },
      {
        ...
        name: 'MyDigital Crown - Digital Marketing Company Udaipur',
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'SEO Services Udaipur',
                description: 'Search Engine Optimization services to rank higher on Google',
                url: 'https://mydigitalcrown.in/udaipur/search-engine-optimisation'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                '@type': 'Service',
                name: 'Social Media Marketing Udaipur',
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Google Ads Management Udaipur',
            ...
            },
            {
              ...
              itemOffered: {
                '@type': 'Service',
                name: 'Web Development Udaipur',
                description: 'Professional website development and design services',
                url: 'https://mydigitalcrown.in/udaipur/web-development'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                url: 'https://mydigitalcrown.in/udaipur/digital-branding'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                url: 'https://mydigitalcrown.in/udaipur/youtube-promotion'
              }
            }
          ]
        },
      ...
      },
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'What is the best digital marketing company in Udaipur?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'MyDigital Crown is one of the leading digital marketing companies in Udaipur, offering 50+ services including SEO, Google Ads, Social Media Marketing, and Web Development with 8+ years of experience and 150+ satisfied clients.'
            }
          },
          {
            '@type': 'Question',
            name: 'How much does digital marketing cost in Udaipur?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Digital marketing costs in Udaipur vary based on services. At MyDigital Crown, we offer customized packages starting from ₹15,000/month for SEO to ₹50,000/month for comprehensive digital marketing solutions.'
            }
          },
          {
            '@type': 'Question',
            name: 'Which digital marketing agency is best in Udaipur?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'MyDigital Crown is recognized as one of the best digital marketing agencies in Udaipur, providing result-driven strategies with a proven track record of 300% average ROI for clients.'
            }
          }
        ]
      },
      ...
      },
      {
        ...
        url: 'https://mydigitalcrown.in',
        name: 'MyDigital Crown - Digital Marketing Company Udaipur',
        description: 'Leading Digital Marketing Company in Udaipur offering SEO, Social Media Marketing, Google Ads, Web Development & 50+ Digital Marketing Services',
        publisher: {
          '@id': 'https://mydigitalcrown.in/#organization'
        },
        potentialAction: [
  ...
  return (
    <>
      ...
      {/* Hero Section - Main Content for Digital Marketing Company in Udaipur */}
      <section 
        className="pt-16 py-16 bg-gradient-to-br from-blue-800 to-blue-600 relative overflow-hidden"
        itemScope 
        itemType="https://schema.org/Organization"
        aria-label="Digital Marketing Company Udaipur Hero Section"
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-3 mb-6 shadow-xl">
                ...
                <span className="text-white font-semibold" itemProp="slogan">Udaipur&apos;s Leading Digital Marketing Company</span>
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              </div>
              ...
              <h1 
                ...
                itemProp="name"
              >
                Digital Marketing Services Near Me in Udaipur | #1 Agency
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                <Link 
                  ...
                  title="Get Free Digital Marketing Consultation Udaipur"
                  aria-label="Contact best digital marketing company in Udaipur for free audit"
                >
                ...
                <a 
                  ...
                  title="Call Best Digital Marketing Agency Udaipur"
                  aria-label="Call MyDigital Crown - Top Digital Marketing Company Udaipur"
                >
                  <span className="relative z-10 flex items-center gap-3">
      ...
      {/* About Us Section - Digital Marketing Consultants Udaipur */}
      <section 
        className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden"
        aria-label="About MyDigital Crown - Digital Marketing Agency Udaipur"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <header className="text-center mb-16">
            <div className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg">
              ...
              Discover MyDigital Crown - Premier Digital Growth Experts in Udaipur
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              What Makes MyDigital Crown Your <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Ideal Digital Success Partner</span> in Udaipur?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              <strong>Searching for reliable digital growth specialists in Udaipur?</strong> We&apos;re a pioneering digital excellence agency in Udaipur empowering businesses through cutting-edge digital transformation strategies since our inception
            </p>
          </header>
              ...
              <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-2 shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                <div className="relative rounded-2xl overflow-hidden bg-white">
                  <Image 
                    ...
                    alt="Aditya Pandey - Founder & Digital Marketing Consultant Udaipur | Best Digital Marketing Company"
                    width={600}
                    height={700}
                    className="w-full h-auto object-cover"
                    priority
                    title="Aditya Pandey - Digital Marketing Expert Udaipur"
                  />
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Welcome to <span className="font-bold text-blue-600">MyDigital Crown</span> - Udaipur&apos;s premier digital marketing agency founded by <span className="font-bold">Aditya Pandey</span>. With over 8 years of industry experience, we&apos;ve helped 50+ businesses achieve remarkable growth through innovative digital marketing strategies.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  ...
                  title="Learn About Udaipur&apos;s Best Digital Marketing Company"
                  aria-label="Learn more about MyDigital Crown - Top Digital Marketing Agency Udaipur"
                >
                  <span className="relative flex items-center">
                    <span className="mr-2">📖</span>
                    Learn About Best Digital Marketing Company Udaipur
                  </span>
                </Link>
                <Link 
                  href="/contact" 
                  ...
                  title="Contact Digital Marketing Agency Udaipur - Free Consultation"
                  aria-label="Contact MyDigital Crown for Digital Marketing Services Udaipur"
                >
      ...
      {/* Services Section - Digital Marketing Services Udaipur */}
      <section 
        className="py-20 bg-white relative overflow-hidden"
        aria-label="Digital Marketing Services in Udaipur"
        itemScope 
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Service 1: SEO */}
            <Link href="/udaipur/search-engine-optimisation" className="group relative rounded-3xl overflow-hidden border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=800&h=600&fit=crop"
                  alt="SEO Services Udaipur - Digital Marketing Company | Search Engine Optimization Agency"
                  fill
            ...
            <Link href="/udaipur/social-media-marketing" className="group relative rounded-3xl overflow-hidden border-2 border-pink-200 hover:border-pink-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&h=600&fit=crop"
                  alt="Social Media Marketing Udaipur - Best Digital Marketing Agency | Instagram Facebook LinkedIn Marketing"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/services/google-ads" className="group relative rounded-3xl overflow-hidden border-2 border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="Google Ads PPC Udaipur - Digital Marketing Company | Pay Per Click Advertising Agency"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/udaipur/web-development" className="group relative rounded-3xl overflow-hidden border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop"
                  alt="Web Development Udaipur - Digital Marketing Company | Custom Website Development Agency"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  loading="lazy"
            ...
            <Link href="/udaipur/digital-branding" className="group relative rounded-3xl overflow-hidden border-2 border-indigo-200 hover:border-indigo-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
            ...
            <Link href="/udaipur/youtube-promotion" className="group relative rounded-3xl overflow-hidden border-2 border-rose-200 hover:border-rose-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
            ...
            <Link href="/udaipur/artificial-intelligence" className="group relative rounded-3xl overflow-hidden border-2 border-violet-200 hover:border-violet-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
            ...
            <Link href="/udaipur/machine-learning" className="group relative rounded-3xl overflow-hidden border-2 border-emerald-200 hover:border-emerald-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0">
                <Image
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              What Udaipur <span className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent">Businesses</span><br />
              Say About Us
            </h2>
            
            <p className="text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed">
              Real results, real clients, real growth stories from Udaipur&apos;s most successful businesses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl">
              ...
              <div className="mb-6">
                ...
                <blockquote className="text-lg text-white/90 leading-relaxed italic">
                  &quot;Our cleaning service flourished after partnering with MyDigital Crown. Their local SEO strategies helped us dominate Udaipur&apos;s market. We now get <span className="text-cyan-400 font-bold">50+ inquiries weekly</span>. Outstanding team!&quot;
                </blockquote>
              </div>
              <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              MyDigital Crown serves clients across India with our main offices strategically located in Udaipur, Varanasi, and Bangalore. Visit us for personalized digital marketing consultations and discover why we&apos;re recognized as a top digital marketing company.
            </p>
            ...
            <div className="group">
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Udaipur Office</h3>
          ...
          <div className="text-center mt-16">
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-12 shadow-2xl border border-white/50 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Schedule a free consultation with our digital marketing experts at any of our three locations - Udaipur, Varanasi, or Bangalore. We&apos;re here to help transform your business with data-driven strategies.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-blue-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Everything you need to know about digital marketing services in Udaipur ✨
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-orange-500/20 hover:border-orange-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-orange-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>What makes MyDigital Crown the best digital marketing company in Udaipur?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p>MyDigital Crown stands out as Udaipur&apos;s premier digital marketing agency with 8+ years of experience, 150+ happy clients, and a proven track record of delivering 300% average growth. We offer 50+ specialized services including SEO, Google Ads, social media marketing, web development, and more. Our data-driven strategies, 24/7 support, and commitment to measurable results make us the preferred choice for businesses in Udaipur looking to dominate their digital landscape.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-blue-500/20 hover:border-blue-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-blue-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>What digital marketing services do you offer in Udaipur?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-green-500/20 hover:border-green-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-green-300 transition-colors">
                <span className="flex items-start gap-4">
                  ...
                  <span>How much does digital marketing cost in Udaipur?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-yellow-500/20 hover:border-yellow-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-yellow-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-bounce">📍</span>
                  <span>Do you provide local SEO services for Udaipur-based businesses?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p className="mb-4">Yes! We specialize in local SEO for Udaipur businesses. Our local SEO services include:</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">✅ Google Business Profile optimization and management</li>
                  <li className="flex items-start gap-2">✅ Local keyword research and targeting (Udaipur-specific)</li>
                  ...
                  <li className="flex items-start gap-2">✅ Map pack optimization for Udaipur searches</li>
                </ul>
                <p className="mt-4">We help your business dominate local search results when potential customers in Udaipur search for your services.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-pink-500/20 hover:border-pink-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-pink-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-pulse">🚀</span>
                  <span>Can you help my small business compete with larger companies in Udaipur?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">📍 Local SEO to dominate specific Udaipur neighborhoods</li>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-cyan-500/20 hover:border-cyan-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-cyan-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-spin">🏢</span>
                  <span>What industries do you serve in Udaipur?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                <p className="mb-4">We serve businesses across all major industries in Udaipur including:</p>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-red-500/20 hover:border-red-300/50 hover:scale-105">
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <p className="mt-4">Our social media experts create engaging content, manage communities, run targeted ad campaigns, and provide detailed analytics to grow your brand presence in Udaipur and beyond.</p>
              </div>
            </details>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-teal-500/20 hover:border-teal-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-teal-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-bounce">🌐</span>
                  <span>Can you help with website design and development in Udaipur?</span>
                </span>
            ...
            <details className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-rose-500/20 hover:border-rose-300/50 hover:scale-105">
              <summary className="flex justify-between items-center cursor-pointer p-8 font-bold text-lg text-white hover:text-rose-300 transition-colors">
                <span className="flex items-start gap-4">
                  <span className="text-4xl mt-1 group-open:animate-pulse">⭐</span>
                  <span>What sets your digital marketing agency apart from others in Udaipur?</span>
                </span>
              ...
              <div className="px-8 pb-8 text-blue-100 leading-relaxed border-t border-white/10 pt-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">📍 <strong>Local Udaipur Expertise:</strong> Deep understanding of Udaipur&apos;s market dynamics</li>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore exciting career opportunities and grow with Udaipur&apos;s leading digital marketing agency
            </p>
          </div>
