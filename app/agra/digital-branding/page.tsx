...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://mydigitalcrown.in/agra/digital-branding',
  },
  openGraph: {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight">
                ...
                <br />
                <span className="text-4xl md:text-6xl">Agra Elite</span>
              </h1>
              ...
              <div itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer">
                <div itemProp="text">
                  <p className="text-gray-600 leading-relaxed mb-4">
                    MyDigital Crown is located in <strong className="text-blue-600">Agra, Agra</strong> - easily accessible from all parts of the city. We serve clients across Agra, Greater Agra, and Mathura.
                  </p>
                  <div className="bg-blue-50 rounded-xl p-4 border-l-4 border-blue-500">
                    <p className="text-sm font-semibold text-blue-900">📍 Office: Agra, Agra, Uttar Pradesh - 282001</p>
