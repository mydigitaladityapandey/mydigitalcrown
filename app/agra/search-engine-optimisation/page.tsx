...
export const metadata: Metadata = {
  title: 'SEO Company Agra | 400+ Clients Ranked #1 | MyDigital',
  description: 'SEO Company Agra. 400+ Clients Ranked #1 | 500% Traffic Growth | Local & National SEO | Google Certified Experts. Call +91-83695-11877',
  keywords: [
    'seo company in agra',
    'seo company agra',
    'seo services agra',
    'seo agency agra',
    'best seo company agra',
    'agra seo company',
    'seo services in agra',
    'search engine optimization agra',
    'seo consultant agra',
    'professional seo services agra',
    'top seo company in agra',
    'seo experts agra',
    'seo agency in agra',
    'agra seo services',
    'local seo agra',
    'seo specialist agra',
    'seo optimization agra',
    'affordable seo agra',
    'seo firm agra',
    'organic seo agra',
    'seo marketing agra',
    ...
    'seo solutions agra',
    'enterprise seo agra',
    'seo consultant in agra',
    'white hat seo agra',
    'agra seo agency',
    'best seo services agra',
    'seo company for small business agra',
    'ecommerce seo agra',
    'technical seo agra',
    'agra seo optimization',
    'seo and digital marketing agra'
  ],
  ...
  openGraph: {
    title: 'SEO Company In Agra | #1 SEO Services Agency',
    description: 'Top SEO Company In Agra. 400+ Clients Ranked #1. 500% Traffic Growth. Expert SEO Services.',
    ...
    images: [
      {
        url: 'https://mydigitalcrown.in/images/seo-company-agra.jpg',
        width: 1200,
        height: 630,
        alt: 'SEO Company In Agra - MyDigital Crown',
      },
    ],
  },
  twitter: {
    ...
    title: 'SEO Company In Agra | #1 SEO Services Agency',
    description: 'Top SEO Company In Agra. 400+ Clients Ranked #1. 500% Traffic Growth. Expert SEO Services.',
    images: ['https://mydigitalcrown.in/images/seo-company-agra.jpg'],
  ...
  alternates: {
    canonical: 'https://mydigitalcrown.in/agra/search-engine-optimisation',
  },
  verification: {
  ...
  const schemaData = {
    ...
    "@graph": [
      // 1. Service Schema
      {
        "@type": "Service",
        "name": "SEO Services",
        "description": "Professional Search Engine Optimization services in Agra delivering 500% traffic growth and #1 Google rankings",
        "provider": {
          "@type": "Organization",
      ...
      // 2. Organization Schema
      {
        ...
        "description": "Agra's #1 SEO Company delivering 500% traffic growth for 400+ clients",
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "Agra",
      ...
      {
        "@type": "WebPage",
        "name": "SEO Company In Agra | #1 SEO Services Agency",
        "description": "Top SEO Company In Agra. 400+ Clients Ranked #1. 500% Traffic Growth. Expert SEO Services.",
        "url": "https://mydigitalcrown.in/services/search-engine-optimisation",
        "inLanguage": "en-IN",
        "isPartOf": {
        ...
        "keywords": "seo company in agra, seo services agra, seo agency agra, best seo company agra"
      },
      ...
      // 5. FAQPage Schema
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What SEO services does your Agra company provide?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "How much do your SEO services cost in Agra?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Can you help with local SEO for Agra businesses?",
            "acceptedAnswer": {
              "@type": "Answer",
      ...
      // 6. ItemList Schema (Services)
      {
        ...
        "description": "Comprehensive SEO services for Agra businesses",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
      ...
      {
        "@type": "Article",
        "headline": "Complete Guide to SEO Company Services in Agra",
        "description": "Comprehensive guide to choosing and working with the best SEO company in Agra",
        "author": {
          "@type": "Organization",
          "name": "MyDigital Crown"
        },
      ...
      {
        "@type": "LocalBusiness",
        "name": "MyDigital Crown - SEO Company Agra",
        "description": "Agra's leading SEO company delivering 500% traffic growth",
        "url": "https://mydigitalcrown.in",
        "telephone": "+91-83695-11877",
    ...
    <>
      ...
      <noscript>
        <div>
          ...
          <p>Address: Agra, Agra, Uttar Pradesh - 282001</p>
        </div>
      </noscript>
      ...
      <section 
        ...
        aria-label="Search Engine Optimization Agra Hero Section"
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="text-center py-16">
              ...
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-3 mb-6 shadow-xl">
                ...
                <span className="text-white font-semibold">Agra&apos;s #1 SEO Company</span>
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              </div>
              
              {/* Main Heading */}
              <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight text-center">
                Premier SEO Agency Agra - MyDigital Crown
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Where is the best SEO company in Agra?</h3>
              <p className="text-blue-100 leading-relaxed">
                MyDigital Crown is Agra&apos;s leading SEO company with offices in Agra, Sikandra, Tajganj, Dayal Bagh, and Mathura. We serve clients across Agra, Greater Agra, and Mathura with expert SEO services that deliver real results.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              <div className="text-4xl mb-4">💰</div>
              <h3 className="text-2xl font-bold text-white mb-4">How much do SEO services cost in Agra?</h3>
              <p className="text-blue-100 leading-relaxed">
                Professional SEO services in Agra range from ₹15,000/month for small businesses to ₹1,00,000+/month for enterprise solutions. Pricing depends on competition, website size, and business goals. We offer custom packages to fit every budget.
              </p>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-3xl p-12 border border-blue-500/30">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-10">
              ...
              <div className="text-center">
                ...
                <p className="text-blue-200">Agra, Agra</p>
              </div>
            </div>
